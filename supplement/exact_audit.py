"""Exact integer/rational audit of the seven-spin numerical examples.
...
def audit(B='0.2',D='2',Jz='1',hx='0',hy='0',save_candidates=None,load_candidates=None):
...
if __name__=='__main__':
    ...
    args=parser.parse_args();print(json.dumps(audit(B=args.B,hx=args.hx),indent=2))
